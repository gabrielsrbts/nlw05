const socket = io();  // criand socket para se conectar
let connectionsUsers = [];

socket.on("admin_list_all_users", (connections) => {  // escutando este evento
...
function call(id) {
  const connection = connectionsUsers.find(  // FIND retorna somente 1 objeto
